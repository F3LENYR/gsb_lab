...
<div style="text-align:center">
    ...
    <img src="/public/assets/img/<?= $substance['chem_formule'] ?>" style="height: auto; width: 150px; filter: invert(1);margin:20px">
                ...
                <?php foreach ($interactions as $interaction) : ?>
                    <li class="collection-item gsb__list-chem">
                        <div style="width:fit-content;margin-right:15px" class="hide-on-small-only">
                            <img src="/public/assets/img/<?= $interaction['chem_formule'] ?>" style="max-width: 50px;transform: scale(1.5);">
                        </div>
                        <div style="width:100%">
